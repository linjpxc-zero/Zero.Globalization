...
namespace Zero.Globalization
{
    ...
    {
        /// <summary>
        /// Try to create an instance of the <see cref="CurrencyInfo"/> based on the ISO-4217 currency code.
        /// </summary>
        /// <param name="code">A ISO 4217 currency code</param>
        /// <param name="result">Return an <see cref="CurrencyInfo"/> instance of the ISO-4217 currency code.</param>
        /// <returns>If the ISO-4217 currency code exists, it returns true, otherwise it returns false.</returns>
        ...
        /// <param name="result">Return an <see cref="CurrencyInfo"/> instance of the ISO-4217 currency code.</param>
        /// <returns>If the ISO-4217 currency code exists, it returns true, otherwise it returns false.</returns>
        public static bool TryFromCode(ReadOnlySpan<char> code, out CurrencyInfo result)
        {
            result = default;
            if (code.IsEmpty)
            {
            ...
            {
                if (code.Equals(currency.Code.AsSpan(), StringComparison.OrdinalIgnoreCase))
                {
                    result = currency;
                    return true;
                }
        ...
        /// <summary>
        /// Try to create an instance of the <see cref="CurrencyInfo"/> based on the ISO-4217 currency numeric.
        /// </summary>
        /// <param name="numeric">A ISO 4217 currency numeric.</param>
        /// <param name="result">Return an <see cref="CurrencyInfo"/> instance of the ISO-4217 currency numeric.</param>
        /// <returns>If the ISO-4217 currency code exists, it returns true, otherwise it returns false.</returns>
        public static bool TryFromNumeric(ReadOnlySpan<char> numeric, out CurrencyInfo result)
        {
            result = default;
            if (numeric.IsEmpty)
            {
            ...
            foreach (var currency in currencies)
            {
                if (numeric.Equals(currency.Numeric.AsSpan(), StringComparison.OrdinalIgnoreCase))
                {
                    result = currency;
                    return true;
                }
        ...
        /// <summary>
        /// Create an abc instance based on ISO-4217 currency code.
        /// </summary>
        /// <param name="code">A ISO 4217 currency code.</param>
        /// <returns>Return an <see cref="CurrencyInfo"/> instance of the ISO-4217 currency code.</returns>
        /// <exception cref="InvalidCurrencyCodeException">Invalid currency code</exception>
        public static CurrencyInfo FromCode(ReadOnlySpan<char> code)
        {
            if (TryFromCode(code, out var result))
            {
                return result;
            }
            throw new InvalidCurrencyCodeException(code.ToString());
        }

        /// <summary>
        /// Create an abc instance based on ISO-4217 currency numeric.
        /// </summary>
        /// <param name="numeric">A ISO 4217 currency numeric.</param>
        /// <returns>Return an <see cref="CurrencyInfo"/> instance of the ISO-4217 currency numeric.</returns>
        /// <exception cref="InvalidCurrencyNumericException">Invalid currency numeric.</exception>
        public static CurrencyInfo FromNumeric(ReadOnlySpan<char> numeric)
        {
            if (TryFromNumeric(numeric, out var result))
            {
                return result;
            }
            throw new InvalidCurrencyNumericException(numeric.ToString());
        }
        ...
        /// <summary>
        /// Try to create an <see cref="CurrencyInfo"/> based on the specified <see cref="RegionInfo"/>.
        /// </summary>
        ...
        /// <summary>
        /// Try to create an <see cref="CurrencyInfo"/> based on the specified <see cref="RegionInfo"/> name.
        /// </summary>
        /// <param name="regionName">Name of the region.</param>
        /// <param name="result">The result.</param>
        /// <returns></returns>
        public static bool TryFromRegion(string regionName, out CurrencyInfo result)
            => TryFromRegion(new RegionInfo(regionName), out result);

        /// <summary>
        /// Try to create an <see cref="CurrencyInfo"/> based on the specified <see cref="CultureInfo"/>.
        /// </summary>
        ...
        /// Culture {culture.Name} is a neutral culture, from which no region information can be extracted! - culture
        /// or
        /// Culture {culture.Name} is a invariant culture, from which no region information can be extracted! - culture
        /// </exception>
        public static bool TryFromCulture(CultureInfo culture, out CurrencyInfo result)
        {
            ...
            {
                throw new ArgumentException($"Culture {culture.Name} is a neutral culture, from which no region information can be extracted!", nameof(culture));
            }

            if (string.IsNullOrWhiteSpace(culture.Name))
            {
                throw new ArgumentException($"Culture {culture.Name} is a invariant culture, from which no region information can be extracted!", nameof(culture));
            }

            return TryFromRegion(culture.Name, out result);
        }
        ...
        public static CurrencyInfo FromNumeric(string numeric)
        {
            ...
            throw new InvalidCurrencyNumericException(numeric);
        }

        /// <summary>
        /// Create an <see cref="CurrencyInfo"/> based on the specified <see cref="RegionInfo"/>.
        /// </summary>
        /// <param name="region">The region.</param>
        /// <returns></returns>
        /// <exception cref="CurrencyException"></exception>
        ...
        /// <summary>
        /// Create an <see cref="CurrencyInfo"/> based on the specified <see cref="RegionInfo"/> name.
        /// </summary>
        /// <param name="regionName">Name of the region.</param>
        /// <returns></returns>
        public static CurrencyInfo FromRegion(string regionName)
            => FromRegion(new RegionInfo(regionName));

        public static CurrencyInfo FromCulture(CultureInfo culture)
        {
            if (TryFromCulture(culture, out var result))
            {
                return result;
            }
            throw new CurrencyException();
        ...
        /// The currencies.
        /// </value>
        public static IEnumerable<CurrencyInfo> Currencies => currencies.AsEnumerable();
